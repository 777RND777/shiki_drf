    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('tv', 'Tv Series'), ('movie', 'Movie'), ('ova', 'Ova'), ('ona', 'Ona'), ('special', 'Special'), ('music', 'Music')], max_length=50)),
                ('episodes', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)])),
                ('status', models.CharField(choices=[('anons', 'Announced'), ('ongoing', 'Airing'), ('released', 'Finished')], max_length=50)),
